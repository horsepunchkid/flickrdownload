...
<!--
  FlickrDownload - Copyright(C) 2007,2010 Brian Masney <masneyb@gmail.com>.
...
<xsl:if test="sets/set[$pos + 0]">
  <xsl:apply-templates select="sets/set[$pos + 0]" mode="set_summary"/>
</xsl:if>
</xsl:template>
